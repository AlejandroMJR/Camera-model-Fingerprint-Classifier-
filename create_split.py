...
load_path = "/nas/home/ajaramillo/projects/Try"
save_path = "/nas/home/ajaramillo/projects/noiseprint_classifier"
...
def main():
    ...
    df_ieee = pd.read_csv(os.path.join(load_path, "ieeeDataset.csv"), sep=",")
    ...
    for c in classes:
        ...
        test_data = pd.concat([test_data, class_data[int(num_samples * (train_frac + val_frac)):]], ignore_index=True)

    train_data.index.name = "id"
    val_data.index.name = "id"
    test_data.index.name = "id"
    # Save pickles
    train_data.to_csv(os.path.join(save_path, 'train_classifier.csv'))
    val_data.to_csv(os.path.join(save_path, 'val_classifier.csv'))
    test_data.to_csv(os.path.join(save_path, 'test_classifier.csv'))
